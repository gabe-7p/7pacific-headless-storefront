...
export const AddToCartBar = ({
  ...
  return (
    <AddToCartButton
      ...
      onClick={() => open('cart')}
      className="bg-brand text-brand-text w-full px-6 py-4 text-sm font-bold tracking-[0.15em] uppercase transition-opacity hover:opacity-90 disabled:opacity-50"
      lines={
