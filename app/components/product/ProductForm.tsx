    ...
    return (
      <div>
        ...
        <div className="flex w-full">
          <span
            className={cn(SIZE_CELL, 'cursor-default border-ink bg-field-night text-ink-night')}
          >
            One Size
          </span>
        </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      selected
                        ...
                        : 'border-border-subtle bg-field text-ink hover:z-10 hover:border-ink focus-visible:z-10',
