...
| ------------------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| **Route** (loader/action) | `app/routes/*`                                                                                                 | Read params, call `context.storefront`/`context.cart`, shape the data the page needs, set `meta` | Render complex UI inline, hold business logic that belongs in `lib/`                 |
| **Lib**                   | `app/lib/`, `app/modules/<m>/lib/`                                                                             | GraphQL fragments, query helpers, pure logic (e.g. `colors`), cross-component utilities          | Render JSX, import React components                                                  |
