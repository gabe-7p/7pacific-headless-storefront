...
2. **Scanners must be tailored.** You are the only actor that has read this repo. A scanner scoped to _this_ product's completion flow is worth ten generic ones.
