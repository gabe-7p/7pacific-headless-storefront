...
| Product card + color swatches | `components/collection/ProductCard`, `components/product/ColorSwatches` | GD-12  |
...
| PDP color swatches            | `components/product/ColorSwatches`                                      | GD-18  |
| Feature carousel              | `components/product/ProductDetails`                                     | GD-19  |
| Tech stack                    | `components/product/TechStack`                                          | GD-20  |
...
- PDP feature/tech content is fully populated for **shorts**; tee/hat sets follow
  Shopify `custom.*` product metafields (all three product types populated).
